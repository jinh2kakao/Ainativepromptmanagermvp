            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
                <div className="flex items-center justify-between gap-4 md:gap-6 h-14 md:h-16">
                    ...
                    <div className="flex items-center gap-3 md:gap-4 flex-shrink-0">
                        <div className="relative h-5 md:h-6 lg:h-7 w-auto aspect-[3/1]">
                            <Image
                                src="/logo.png"
                                alt="Promit Logo"
                                width={120}
                    ...
                    <div className="flex items-center gap-1 bg-gray-100 p-0.5 md:p-1 rounded-lg shadow-inner">
                        <button
                            ...
                            className={`px-2 md:px-4 py-1.5 md:py-2 rounded-md flex items-center gap-1.5 md:gap-2 transition-all duration-200 min-h-[36px] md:min-h-0 ${viewMode === 'list'
                        ...
                        <button
                            ...
                            className={`px-2 md:px-4 py-1.5 md:py-2 rounded-md flex items-center gap-1.5 md:gap-2 transition-all duration-200 min-h-[36px] md:min-h-0 ${viewMode === 'kanban'
                                ? 'bg-white text-gray-900 shadow-sm'
                                : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                                }`}
                        >
