                        ...
                        <div className="flex items-center gap-1.5 md:gap-2">
                            ...
                            {isOwner && (
                                <button
                                    ...
                                    className={`px-2.5 md:px-3 py-2 rounded-lg flex items-center gap-1.5 md:gap-2 text-xs md:text-sm transition-all duration-200 border min-h-[40px] md:min-h-0 ${isPublic
            ...
            <div className="max-w-4xl mx-auto px-4 md:px-6 lg:px-8 py-4 md:py-8">
                ...
                <div className="mb-6 md:mb-8">
                    ...
                    <div className="flex items-center gap-1.5 md:gap-2 flex-wrap text-xs md:text-sm">
                        ...
                        <span className={`px-2 md:px-3 py-1 md:py-1.5 rounded-lg flex items-center gap-1 md:gap-1.5 border ${isPublic
