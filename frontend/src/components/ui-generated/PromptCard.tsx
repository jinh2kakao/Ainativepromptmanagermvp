...
export function PromptCard({ prompt, onRun, onEdit, onDelete, onPromptClick, view = 'list' }: PromptCardProps) {
        ...
        return (
            ...
            >
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-200" onClick={(e) => e.stopPropagation()}>
                        <button
                        ...
                        <button
                            ...
                            className="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-all min-h-[36px] min-w-[36px] flex items-center justify-center"
                            title="Delete"
                        >
    ...
    return (
        ...
        >
            <div className="flex items-start justify-between gap-3 md:gap-4">
                ...
                {/* Mobile: Always visible / Desktop: Hover */}
                <div className="flex items-center gap-1 flex-shrink-0 md:opacity-0 md:group-hover:opacity-100 transition-opacity duration-200" onClick={(e) => e.stopPropagation()}>
                    <button
                        onClick={handleQuickCopy}
                        className="p-2 text-gray-600 hover:bg-blue-50 hover:text-blue-600 rounded-lg transition-all min-h-[36px] min-w-[36px] flex items-center justify-center"
                        title={prompt.variables.length > 0 ? 'Run with variables' : 'Copy'}
