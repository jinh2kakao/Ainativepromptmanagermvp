...
import { useAddTeamMember } from '@/features/teams/useTeamHooks';
...
export function InviteMemberModal({ isOpen, onClose, teamId }: InviteMemberModalProps) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        addMember({ teamId, data: { email, role } }, {
            onSuccess: () => {
                setEmail('');
                setRole('viewer');
                onClose();
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <option value="editor">Editor (Can create/edit projects)</option>
                                    <option value="admin">Admin (Manage team & members)</option>
                                </select>
                            </div>
                        </div>
                    </div>
