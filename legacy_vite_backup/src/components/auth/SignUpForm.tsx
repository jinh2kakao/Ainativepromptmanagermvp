...
export function SignUpForm({ onSwitchToLogin, onSignUpSuccess }: SignUpFormProps) {
  ...
  const handleVerifyCode = () => {
    if (verificationCode === '123456') {
      ...
      setErrors({ code: '인증번호가 일치하지 않습니다' });
    }
  };
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className={`w-full pl-10 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all disabled:bg-gray-50 disabled:text-gray-500 ${
                    errors.email
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 space-y-3">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="123456"
                      maxLength={6}
                      className={`flex-1 px-4 py-3 border rounded-lg focus:outline-none focus:ring-2 transition-all text-center tracking-widest ${
                        errors.code
                          ? 'border-red-300 focus:ring-red-500'
                          : 'border-gray-300 focus:ring-blue-500'
                      }`}
