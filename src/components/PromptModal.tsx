            ...
            <div>
              ...
              <div className="flex items-center gap-2 bg-gray-100 p-1 rounded-lg w-full md:w-fit shadow-inner">
                <button
                  ...
                  className={`flex-1 md:flex-none px-3 md:px-4 py-2.5 md:py-2 rounded-md flex items-center justify-center gap-2 transition-all duration-200 text-sm min-h-[44px] md:min-h-0 ${
                    mode === 'simple'
